...
= 5.7.0-RC1 =
* Fixed bug when changing field type causing new empty field to appear on save
* Improved conditional logic to correctly render a chain of connected fields
* Improved numeric value handling in conditional logic types
* Fixed missing translations in Select2
* Removed “Custom Fields” from “Hide on screen” settings
* Fixed google map JS errors
